...
protocol RMSearchViewDelegate: AnyObject {
  ...
  func rmSearchView(
    _ searchView: RMSearchView, didSelectOption option: RMSearchInputViewVM.DynamicOption
  )

  func rmSearchView(
    _ searchView: RMSearchView, didSelectLocation location: RMLocation
  )

  func rmSearchView(
    _ searchView: RMSearchView, didSelectCharacter location: RMCharacter
  )

  func rmSearchView(
    _ searchView: RMSearchView, didSelectEpisode location: RMEpisode
  )
